...
class AdditionActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        myAnim = AnimationUtils.loadAnimation(this@AdditionActivity, R.anim.dialog_anim_up)
        ...
        handler.postDelayed({
            ...
            if (!gameClosed) {
                ...
                showGameOverDialog(this@AdditionActivity, score, userResult)
            }
        }, 500)
    }
